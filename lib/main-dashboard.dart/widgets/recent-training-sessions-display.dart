...
import 'package:gym_tracker_flutter/training-session/training-session-details/training-session-detail-page.dart';
...
class _RecentTrainingSessionsDisplayState
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TrainingSession>>(
      future: TrainingSessionService().getRecentTrainingSessions(),
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        PageTransition(
                          ...
                          child: TrainingSessionDetailPage(
